...
namespace smartHookah.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var person = UserHelper.GetCurentPerson(_db, user.PersonId);
        ...
        public async Task<ActionResult> EditUserSetting(int? id)
        {
            ...
            var model = new PersonSetingViewModel();
            model.Person = person;
            model.CanEdit = true;
        ...
        public async Task<ActionResult> EditUserSetting(PersonSetingViewModel model)
        {
            if (ModelState.IsValid)
            {
                var person = await _db.Persons.FindAsync(model.Person.Id);
                if (person == null)
                    return RedirectToAction("Index");
                person.AutoAssign = model.Person.AutoAssign;
                person.MyGear = model.Person.MyGear;
                person.MyTobacco = model.Person.MyTobacco;
